...
function Footer() {
  return (
    <div className='p-5 pt-4 w-100 bg-info '>
      <Grid container spacing={2}>
        <Grid xs={12} lg={5}>
          <div  className="intro">
            <h5><Link className='fw-bolder ' to={'/'} style={{ color: "#fff", textDecoration: "none" }}><img width={"30px"} src={logo} alt="Logo" /> DINE HUB </Link></h5>
            <p className='text-white '>Designed and built with all the love in the world by the Dine hub team with the help of our contributors.</p>
      ...
      <p className='text-center text-white  mt-2 mb-0'>Copyright © DINE HUB  2024 . Built with React.</p>
    </div>
  )
}
